...
//            System.err.println("Two-digit year in Date (guessing " + year + "): " + line);
        }
        ...
        if (timeString == null) {
//            System.err.println("Time not given in Date (assuming 00:00:00 GMT): " + line);
        } else {
            StringReader timeReader = new StringReader(timeString);
            hh = consumeInt(timeReader);
            if (hh == -1) {
//                System.err.println("Unparsable hours (assuming 00:00:00): " + line);
                hh = 0;
            } else {
                mm = consumeInt(timeReader);
                if (mm == -1) {
//                    System.err.println("Unparsable minutes (assuming " + hh + ":00:00): " + line);
                    mm = 0;
                } else {
                    ss = consumeInt(timeReader);
                    if (ss == -1) {
//                        System.err.println("Unparsable seconds (assuming " + hh + ":" + mm + ":00): " + line);
                        ss = 0;
                    }
                }
            }
            ...
            if (tz == null) {
//                System.err.println("Unparsable timezone (assuming GMT): " + line);
...
/*
        ...
        System.out.println(year + "/" + month + "/" + day + " "
                + hh + " " + mm + " " + ss + " " + tz.getID() + " => " + df.format(date));
*/
    }
...
//                System.err.println("NOTE: Getting timezone from java '" + token + "'");
    ...
    private static String consumeLetters(StringReader reader,
            int maxLetters) {
